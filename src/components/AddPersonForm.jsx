...
const AddPersonForm = () => {
  ...
  const handleNameChange = (event) => setEnteredName(event.target.value);
  ...
  // send request to add the person
  const addPerson = async (e) => {
    ...
    if (
      createPerson.name === "" ||
      createPerson.sectors === [] ||
      createPerson.terms === ""
    ) {
      setToastOpen(true);
      if (createPerson.name === "") setMessageText("Please enter your name");
      else if (createPerson.sectors === [])
